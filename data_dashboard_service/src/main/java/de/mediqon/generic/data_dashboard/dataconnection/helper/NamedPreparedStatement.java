package de.mediqon.generic.data_dashboard.dataconnection.helper;
...
public class NamedPreparedStatement extends PreparedStatementImpl {
    ...
    public void setObject(String parameter, Object x) throws SQLException {
        for (Integer i : getParameterIndexes(parameter)) {
            ...
            this.originalSQL = this.originalSQL.replaceFirst("(?i):" + parameter, Matcher.quoteReplacement(format((Object) x, FormatType.OBJECT)));
        }
    }
